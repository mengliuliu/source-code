 ...
 * @param sel 标签名
 * @param data dom的配置对象
 * @param children dom的子节点
 * @param text 文本节点的内容
 * @param elm 虚拟dom对应的真实dom
 */
...
function init$1(modules, domApi, options) {
    ...
    return function patch(oldVnode, vnode) {
        console.log('patch前oldVnode', oldVnode)
        console.log('patch前vnode', vnode)
        let i, elm, parent;
        ...
        for (i = 0; i < cbs.post.length; ++i)
            ...
            console.log('patch后oldVnode', oldVnode)
            console.log('patch后vnode', vnode)
        return vnode;
    };
}
